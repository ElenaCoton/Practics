...
namespace MvcCreditApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //возвращает соответствующее представление c получением всех записей о кредитах и заявках:
            GiveCredits();
        ...
        //асинхронную операцию «Извлечение из БД нужной информации в частичное представление»:
