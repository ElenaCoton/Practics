...
namespace Lab6
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nВведите сторону равнозначного треугольника номер 3:");
            p1 = double.Parse(Console.ReadLine());
            Triangle t3 = new Triangle(p1);

            Console.WriteLine("Сортировка двух треугольников по их площади");
            List<Triangle> list = new List<Triangle>();
            if (t1.IsExistsTriangle()) list.Add(t1);
            if (t2.IsExistsTriangle()) list.Add(t2);
            if (t3.IsExistsTriangle()) list.Add(t3);
            list.Sort();
